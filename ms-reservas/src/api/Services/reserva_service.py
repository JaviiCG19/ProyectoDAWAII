...
class ReservaListAllService(Resource):
    ...
    def get():
        ...
        try:
            HandleLogs.write_log("Servicio para listar TODAS las reservas por local ejecutado")
            ...
            # 3. Llamar al componente con el idlocal
            resultado = ReservaComponent.listar_todas_reservas(idlocal)
